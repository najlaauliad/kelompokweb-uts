          ...
          <div class="col-sm-7">
            <select class="form-control" id="penerbit" name="penerbit">
              ...
              while ($data_t = mysqli_fetch_row($query_t)) {
                ...
                $terbit = $data_t[1];
              ?>
                <option value="<?php echo $id_terbit; ?>" <?php if ($id_terbit == $id_penerbit) { ?> selected <?php } ?>><?php echo $terbit; ?></option>
              <?php } ?>
            </select>
          </div>
        ...
        <div class="form-group row">
          ...
          <div class="col-sm-7">
            ...
            while ($data_g = mysqli_fetch_row($query_g)) {
              ...
              $tg = $data_g[1];
            ?>
              <input type="checkbox" name="tag[]" value="<?php echo $id_tg; ?>" <?php if (in_array($id_tg, $array_tag)) { ?>checked="checked" <?php } ?>>
              <?php echo $tg; ?> </br>
            <?php } ?>
          </div>
        </div>
