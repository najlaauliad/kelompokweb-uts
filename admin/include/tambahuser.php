        ...
        <div class="card card-info">
          ...
          <div class="col-sm-10">
            <?php if (!empty($_GET['notif'])) { ?>
              <?php
              if ($_GET['notif'] == "fotokosong") { ?>
                <div class="alert alert-danger" role="alert">Maaf foto wajib di isi</div>
              <?php } ?>
              <?php
              ...
              <?php } ?>
              <?php
              if ($_GET['notif'] == "emailkosong") { ?>
                <div class="alert alert-danger" role="alert">Maaf email wajib wajib di isi</div>
              <?php } ?>
              <?php
              if ($_GET['notif'] == "usernamekosong") { ?>
                <div class="alert alert-danger" role="alert">Maaf username wajib wajib di isi</div>
              <?php } ?>
              <?php
              if ($_GET['notif'] == "passwordkosong") { ?>
                <div class="alert alert-danger" role="alert">Maaf password wajib wajib di isi</div>
              <?php } ?>
            <?php } ?>
          </div>
