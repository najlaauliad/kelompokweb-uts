    ...
    <div class="card-body">
      ...
      <table class="table table-bordered">
        ...
        <tbody>
          ...
          if (!empty($katakunci_blog)) {
            $sql_k .= " where `judul` LIKE '%$katakunci_blog%'";
          }
          $sql_k .= " ORDER BY `k`.`kategori_blog`, `b`.`judul` limit $posisi, $batas ";
          ...
          ?>
            <tr>
              ...
              <td align="center">
                <a href="index.php?include=edit-blog&data=<?php echo $id_blog; ?>" class="btn btn-xs btn-info"><i class="fas fa-edit"></i></a>
                <a href="index.php?include=detail-blog&data=<?php echo $id_blog; ?>" class="btn btn-xs btn-info" title="Detail"><i class="fas fa-eye"></i></a>
                <a href="javascript:if(confirm('Anda yakin ingin menghapus data <?php echo $judul; ?>?'))window.location.href = 'index.php?include=blog&aksi=hapus&data=<?php echo $id_blog; ?>&notif=hapusberhasil'" class="btn btn-xs btn-warning"><i class="fas fa-trash"></i></a>
              </td>
            </tr>
          <?php $no++;
          } ?>
